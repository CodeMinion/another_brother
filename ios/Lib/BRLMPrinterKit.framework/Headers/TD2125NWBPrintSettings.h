...
@interface TD2125NWBPrintSettings : GenericMobileLabelModelPrintSettings <PrintSettingsDelegate>

// These definitions are provided for information only. DO NOT MODIFY!
#define TD2125NWB_RESOLUTION_HORZ 203
#define TD2125NWB_RESOLUTION_VERT 203
// spec section 2.3.5 Raster Line
#define TD2125NWB_HEADSIZEDOTS 448
...
#define TD2125NWB_MAX_COMPRESS_LENGTH 56

// not in spec. Used Windows Printer Driver as reference.
// NOTE: MAXPAPERWIDTH can exceed HEADSIZEDOTS!!
#define TD2125NWB_MIN_PAPERWIDTHDOTS (0.47F * TD2125NWB_RESOLUTION_HORZ) // 95
#define TD2125NWB_MAX_PAPERWIDTHDOTS (2.48F * TD2125NWB_RESOLUTION_VERT) // 503
// spec section 2.3.4 Maximum and Minimum Lengths
#define TD2125NWB_MIN_PAPERLENGTHDOTS 96
#define TD2125NWB_MAX_PAPERLENGTHDOTS 7992
...
#define TD2125NWB_MIN_MARGINLENGTHDOTS 24
...
#define TD2125NWB_MIN_MARGINLENGTHDOTS 0
...
#define TD2125NWB_MIN_PAGEFEEDDOTS_LASTPAGE 24

#endif

#define TD2125NWB_MAX_MARGINLENGTHDOTS 1015
// Arbitrarily restrict extraFeed to 11" at 203 dpi. There is no reason to be larger.
#define TD2125NWB_MAX_EXTRAFEEDDOTS (11*TD2125NWB_RESOLUTION_VERT)

//*** IMPORTANT ***
// SDK Users:
// You should NEVER instantiate an object of the GenericMobileLabelModelPrintSettings superclass.
// Instead, you should instantiate one of the model-specific subclasses (i.e. TD2125NWBPrintSettings).
//
