...
@interface TD2135NPrintSettings : GenericMobileLabelModelPrintSettings <PrintSettingsDelegate>

// These definitions are provided for information only. DO NOT MODIFY!
// spec section 2.3.1 Resolution
#define TD2135N_RESOLUTION_HORZ 300
#define TD2135N_RESOLUTION_VERT 300
// spec section 2.3.5 Raster Line
#define TD2135N_HEADSIZEDOTS 672
...
#define TD2135N_MAX_COMPRESS_LENGTH 84

// not in spec. Used Windows Printer Driver as reference.
// NOTE: MAXPAPERWIDTH can exceed HEADSIZEDOTS!!
#define TD2135N_MIN_PAPERWIDTHDOTS (0.47F * TD2135N_RESOLUTION_HORZ) // 141
#define TD2135N_MAX_PAPERWIDTHDOTS (2.48F * TD2135N_RESOLUTION_VERT) // 744
// spec section 2.3.4 Maximum and Minimum Lengths
#define TD2135N_MIN_PAPERLENGTHDOTS 142
#define TD2135N_MAX_PAPERLENGTHDOTS 11811
...
#define TD2135N_MIN_MARGINLENGTHDOTS 35
...
#define TD2135N_MIN_MARGINLENGTHDOTS 0
...
#define TD2135N_MIN_PAGEFEEDDOTS_LASTPAGE 35

#endif

#define TD2135N_MAX_MARGINLENGTHDOTS 1500
// Arbitrarily restrict extraFeed to 11" at 203 dpi. There is no reason to be larger.
#define TD2135N_MAX_EXTRAFEEDDOTS (11*TD2135N_RESOLUTION_VERT)

//*** IMPORTANT ***
// SDK Users:
// You should NEVER instantiate an object of the GenericMobileLabelModelPrintSettings superclass.
// Instead, you should instantiate one of the model-specific subclasses (i.e. TD2135NPrintSettings).
//
