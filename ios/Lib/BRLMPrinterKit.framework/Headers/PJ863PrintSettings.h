...
@interface PJ863PrintSettings : GenericPocketJetPrintSettings <PrintSettingsDelegate>

// These constants below are provided for reference only. DO NOT MODIFY!
#define PJ863_RESOLUTION_HORZ 300
#define PJ863_RESOLUTION_VERT 300

// Arbitrarily restrict extraFeed to 11" at 300 dpi. There is no reason to be larger.
#define PJ863_MAX_EXTRAFEEDDOTS (11*PJ863_RESOLUTION_VERT)
...
#define PJ863_CUSTOM_WIDTHDOTS_MIN 1200 // 4" due to likely skewing of narrower paper. Otherwise can be lower.
#define PJ863_CUSTOM_WIDTHDOTS_MAX 2550 // 8.5" = max paper width
#define PJ863_CUSTOM_LENGTHDOTS_MIN 600 // 2" to allow PerfRoll paper to print anything due to large unprintable area
#define PJ863_CUSTOM_LENGTHDOTS_MAX 30000 // 100", arbitrary

//*** IMPORTANT ***
// SDK Users:
// You should NEVER instantiate an object of the GenericPocketJetPrintSettings class.
// Instead, you should instantiate one of the model-specific subclasses (i.e. PJ863PrintSettings).
//
