...
#import "TbPrintLabelMethodCall.h"

@implementation TbPrintLabelMethodCall

static NSString * METHOD_NAME = @"typeB-printLabel";
...
- (void)execute {
    ...
    dispatch_queue_t queue = dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0ul);
            dispatch_async(queue, ^{
                ...
                NSNumber * quantity = self->_call.arguments[@"quantity"];
                NSNumber * copies = self-> _call.arguments[@"copy"];
                ...
                success = [printer printlabel:[quantity stringValue] copies:[copies stringValue]] == 1;
