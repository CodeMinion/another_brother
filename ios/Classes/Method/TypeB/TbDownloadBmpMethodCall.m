...
#import "TbDownloadBmpMethodCall.h"

@implementation TbDownloadBmpMethodCall

static NSString * METHOD_NAME = @"typeB-downloadBmp";
...
- (void)execute {
    ...
    dispatch_queue_t queue = dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0ul);
            dispatch_async(queue, ^{
                ...
                success = [printer downloadbmp:filePath asName:brotherFileName] == 1;
